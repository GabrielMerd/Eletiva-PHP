...
<div class="container">
    ...
    <form action="<?php echo e(route('manutencoes.update', $maintenance->id)); ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="date" name="start_date" id="start_date" class="form-control" value="<?php echo e($maintenance->start_date); ?>">
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Desktop\projetobd\resources\views/maintenance/edit.blade.php ENDPATH**/ ?>